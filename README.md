...
| **Active** | Expand audited Git capabilities as named functions | File history/blame, restore-file-version, recent-signature audit, source archives, full-history bundle export/verification, and guided shallow cloning are done; sparse checkout, patch exchange/bundle import, interactive rebase, signing setup, hooks, LFS, remotes, and deeper worktree administration follow |
...
| **P1 Git** | Command palette; full interactive-rebase todo editor; shallow and sparse controls; signing settings; hooks, LFS, remotes, worktrees, patch exchange, and bundle import | **Restore-file, shallow-clone, and bundle export/verify slices done; remaining functions planned** |
