...
| **Active** | Expand audited Git capabilities as named functions | File history/blame, restore-file-version, recent-signature audit, source archives, and full-history bundle export are done; patch exchange/bundle import, interactive rebase, shallow/sparse controls, signing setup, hooks, LFS, remotes, and deeper worktree administration follow |
| **Active** | Expand named GitHub functions on a hardened transport | GitHub.com REST versioning and credential/header precedence are done; bounded/cancellable Notifications API methods are done and their interactive source panel is underway, followed by Issues, PR review/merge, Releases, repository rules/settings, and deeper Actions administration |
...
| **P1 Git** | Command palette; full interactive-rebase todo editor; shallow and sparse controls; signing settings; hooks, LFS, remotes, worktrees, patch exchange, and bundle import | **Restore-file and bundle export/verify slices done; remaining functions planned** |
| **P1 GitHub** | Notifications; Issues; PR authoring/review/merge; Releases/assets; repository rules/settings/collaborators; Actions artifacts/caches/runners/secrets/variables/environments | **Notifications active; remaining functions planned** |
