...
Desktop Material discovers a broad curated set of installed editors on
Windows, macOS, and Linux, including Visual Studio Code/VSCodium variants,
JetBrains IDEs, Sublime Text, Vim/Neovim front ends, and platform-specific
tools. Users may instead configure a custom executable and arguments.
...
Verification includes platform editor discovery suites, custom integration
